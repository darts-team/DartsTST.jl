...
# filename = "syncModule2_MonteCarlo_mode_3_USO_sync_pri_sweep_noFreq.jld2"
...
vals2 = ideal_PSLR[2] .- PSLRs[2,:,:]
vals3 = ideal_PSLR[3] .- PSLRs[3,:,:]
p1 = boxplot(sync_PRIs,vals1',title = "PSLR Change Lat (dB)",
 xlabel = "SRI (s)", legend = false)
p2 = boxplot(sync_PRIs,vals2',title = "PSLR Change Lon (dB)",
  xlabel = "SRI (s)", legend = false)
p3 = boxplot(sync_PRIs,vals3',title = "PSLR Change Height (dB)",
  xlabel = "SRI (s)", legend = false)
display(plot(p1, p2, p3, layout = (3,1), legend = false))
# savefig("USO_SRI_sweep_no_phase_ramp_pslr_change.png")
...
vals2 = ideal_ISLR[2] .- ISLRs[2,:,:]
vals3 = ideal_ISLR[3] .- ISLRs[3,:,:]
p1 = boxplot(sync_PRIs,vals1',title = "ISLR Change Lat (dB)",
 xlabel = "SRI (s)", legend = false)
p2 = boxplot(sync_PRIs,vals2',title = "ISLR Change Lon (dB)",
  xlabel = "SRI (s)", legend = false)
p3 = boxplot(sync_PRIs,vals3',title = "ISLR Change Height (dB)",
  xlabel = "SRI (s)", legend = false)
display(plot(p1, p2, p3, layout = (3,1), legend = false))
# savefig("USO_SRI_sweep_no_phase_ramp_islr_change.png")
...
vals2 = (ideal_res[2] .- resolutions[2,:,:]) .*110e3
vals3 = (ideal_res[3] .- resolutions[3,:,:])
p1 = boxplot(SRI_plot, vals1', title = "Resolution Change Lat (deg*110km -> m)",
 xlabel = "SRI (s)", legend = false)
p2 = boxplot(SRI_plot, vals2', title = "Resolution Change Lon (deg*110km -> m)",
  xlabel = "SRI (s)", legend = false)
p3 = boxplot(SRI_plot, vals3', title = "Resolution Change Height (m)",
   xlabel = "SRI (s)", legend = false)
display(plot(p1, p2, p3, layout = (3,1), legend = false))
# savefig("USO_SRI_sweep_no_phase_ramp_resolution_change.png")
...
vals2 = loc_errors[2,:,:] .*110e3
vals3 = loc_errors[3,:,:] 
p1 = boxplot(SRI_plot, vals1', title = "Peak Location Error Lat (deg*110km -> m)",
 xlabel = "SRI (s)", legend = false)
p2 = boxplot(SRI_plot, vals2', title = "Peak Location Error Lon (deg*110km -> m)",
  xlabel = "SRI (s)", legend = false)
p3 = boxplot(SRI_plot, vals3', title = "Peak Location Error Height (m)",
   xlabel = "SRI (s)", legend = false)
display(plot(p1, p2, p3, layout = (3,1), legend = false))
# savefig("USO_SRI_sweep_no_phase_ramp_peak_loc.png")