...
Srx=Srx/maximum(Srx) # normalize to 1 so that noise level based on SNR is added correctly.
...
rawdata=Generate_Raw_Data.main_RSF_slowtime(t_xyz_grid,p_xyz,mode,tx_el,fc,Srx,t_rx,ref_range,SNR)
# plot raw data (RSF)
