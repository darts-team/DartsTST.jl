...
display_tomograms=0 # how to display tomograms, 0: do not display, 1: display only 3 slices at reference point, 2: display all slices in each dimension, 3: display as 3D scatter plot
