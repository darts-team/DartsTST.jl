...
SAR_start_time=112 # SAR imaging start time (s)
...
s_loc_1=-65:0.2:65 # deg longitude if LLH, cross-track if SCH, Y if XYZ
s_loc_3=-60:0.2:60 # m  heights if LLH or SCH, Z if XYZ
distance_ratio=8
