...
## PLATFORM LOCATIONS
orbit_filename = "inputs/orbitOutput_082020.nc"
orbit_dataset=Dataset(orbit_filename) # Read orbits data in NetCDF format TODO take from input parameters
...
if enable_fast_time # with fastime, with slowtime
    @time image_1xN=Process_Raw_Data.main_RSF_slowtime(rawdata_sync,s_xyz_grid,p_xyz,mode,tx_el,fc,t_rx,ref_range)
