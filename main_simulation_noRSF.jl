...
#savefig("targets.png")
## GENERATE RAW DATA
rawdata=Generate_Raw_Data.main(t_xyz_grid,p_xyz_grid,mode,tx_el,fc) #TODO use structure as input
# plot raw data
if mode==3
...
image_3xN=Process_Raw_Data.main(rawdata,s_xyz_grid,p_xyz_grid,mode,tx_el,fc)
