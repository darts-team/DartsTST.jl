...
for jjj=1:10
        ...
        num_targ_vol            = 3
        t_loc_S_range           = -16:2:16#0#-2:0.25:2 #20
        t_loc_C_range           = -30:5:30#0#-2:0.25:2 #40
...
=#
       ...
       #try
        ...
        #trunc_fac= Int(round(2*(max_range-min_range)/c/params.Δt,digits=-1))+8000
        #C,D = findmax(Srx)
    ...
    display(p2)
        ...
        p1 = (plot!((t_ref_all').^2,collect(t_loc_H_range),ylabel="Height (H axis) [m]",xlabel="Reflectivity input",title ="Back-projection output \n Normalized Intensity", label="", lw=2,
        tickfont=font(13), xtickfont=font(13), ytickfont=font(13), guidefont=font(13), titlefontsize=13, size=(500,360) ))
        display(p1)
