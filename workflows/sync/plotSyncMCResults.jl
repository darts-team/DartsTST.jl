...
begin 
  ...
  # filename = "sync data/syncModule_MonteCarlo_mode_2_RFSoC_sync_pri_sweep_wFreq.jld2"# this uses sync_data/*, a folder which isn't used on the master branch
  # filename = "sync data/syncModule_MonteCarlo_mode_2_RFSoC_NOsync_pri_sweep_noFreq.jld2"
  # filename = "sync data/syncModule_MonteCarlo_mode_2_RFSoC_sync_pri_sweep_noFreq.jld2"
...
## trying box plots # ---- Peak loss ------
  ...
  display(boxplot(SRI_plot, peakvals', title = "Peak Power Loss (dB)",
    xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_peak_loss.png")
  savefig("RFSoC_SIMO_SRI_sweep_peak_loss.png")
  ...
  makeBoxPlot(sync_PRIs,vals1,"PSLR Change Along-Track (dB)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_pslr_change_AT.png")
  makeBoxPlot(sync_PRIs,vals2,"PSLR Change Cross-Track (dB)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_pslr_change_CT.png")
  makeBoxPlot(sync_PRIs,vals3,"PSLR Change Height (dB)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_pslr_change_hgt.png")
  ...
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_pslr_change_CT.png")
  # display(boxplot(sync_PRIs,vals2',title = "PSLR Change Along-Track (dB)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_pslr_change_AT.png")
  # display(boxplot(sync_PRIs,vals3',title = "PSLR Change Height (dB)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_pslr_change_hgt.png")
  ...
  makeBoxPlot(sync_PRIs,vals1,"ISLR Change Along-Track (dB)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_islr_change_AT.png")
  makeBoxPlot(sync_PRIs,vals2,"ISLR Change Cross-Track (dB)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_islr_change_CT.png")  
  makeBoxPlot(sync_PRIs,vals3,"ISLR Change Height (dB)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_islr_change_hgt.png")
  
  # display(boxplot(sync_PRIs,vals1',title = "ISLR Change Cross-Track (dB)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_islr_change_CT.png")
  # display(boxplot(sync_PRIs,vals2',title = "ISLR Change Along-Track (dB)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_islr_change_AT.png")
  # display(boxplot(sync_PRIs,vals3',title = "ISLR Change Height (dB)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_islr_change_hgt.png")
  ...
  makeBoxPlot(sync_PRIs,vals1,"Resolution Change Along-Track (m)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_resolution_change_AT.png")
  makeBoxPlot(sync_PRIs,vals2,"Resolution Change Cross-Track (m)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_resolution_change_CT.png")
  makeBoxPlot(sync_PRIs,vals3,"Resolution Change Height (m)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_resolution_change_hgt.png")
  
  
  # display(boxplot(sync_PRIs,vals1',title = "Resolution Change Cross-Track",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_resolution_change_CT.png")
  # display(boxplot(sync_PRIs,vals2',title = "Resolution Change Along-Track (m)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_resolution_change_AT.png")
  # display(boxplot(sync_PRIs,vals3',title = "Resolution Change Height (m)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_resolution_change_hgt.png")

  # ---- Peak location error ------
  vals1 = filterNaNs2D(loc_errors[1,:,:])
  vals2 = filterNaNs2D(loc_errors[2,:,:])
  vals3 = filterNaNs2D(loc_errors[3,:,:])
  makeBoxPlot(sync_PRIs,vals1,"Peak Location Error Along-Track (m)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_peak_loc_AT.png")
  makeBoxPlot(sync_PRIs,vals2,"Peak Location Error Cross-Track (m)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_peak_loc_CT.png")
  makeBoxPlot(sync_PRIs,vals3,"Peak Location Error Height (m)","RFSoC_SIMO_SRI_sweep_with_phase_ramp_peak_loc_hgt.png")
  
  # display(boxplot(SRI_plot, vals1', title = "Peak Location Error Cross-Track (m)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  #  savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_peak_loc_lat.png")
  # display(boxplot(SRI_plot, vals2', title = "Peak Location Error Along-Track (m)",
  #   xlabel = "Sync Repetition Interval (s)", legend = false))
  #   savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_peak_loc_lon.png")
  # display(boxplot(SRI_plot, vals3', title = "Peak Location Error Height (m)",
  #    xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("RFSoC_SIMO_SRI_sweep_with_phase_ramp_peak_loc_hgt.png")
