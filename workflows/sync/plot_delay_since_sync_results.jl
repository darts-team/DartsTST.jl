...
## trying box plots # ---- Peak loss ------
  ...
  makeBoxPlot(delays,vals1,"PSLR Change Along-Track (dB)","RFSoC_meas_SIMO_DSS_sweep_pslr_change_AT.png")
  makeBoxPlot(delays,vals2,"PSLR Change Cross-Track (dB)","RFSoC_meas_SIMO_DSS_sweep_pslr_change_CT.png")
  makeBoxPlot(delays,vals3,"PSLR Change Height (dB)","RFSoC_meas_SIMO_DSS_sweep_pslr_change_hgt.png")
  ...
  #  xlabel = "Delay Since Last Sync (s)", legend = false))
  # savefig("RFSoC_meas_SIMO_DSS_sweep_pslr_change_CT.png")
  # display(boxplot(delays,vals2',title = "PSLR Change Along-Track (dB)",
  #  xlabel = "Delay Since Last Sync (s)", legend = false))
  # savefig("RFSoC_meas_SIMO_DSS_sweep_pslr_change_AT.png")
  # display(boxplot(delays,vals3',title = "PSLR Change Height (dB)",
  #  xlabel = "Delay Since Last Sync (s)", legend = false))
  # savefig("RFSoC_meas_SIMO_DSS_sweep_pslr_change_hgt.png")
  ...
  makeBoxPlot(delays,vals1,"ISLR Change Along-Track (dB)","RFSoC_meas_SIMO_DSS_sweep_islr_change_AT.png")
  makeBoxPlot(delays,vals2,"ISLR Change Cross-Track (dB)","RFSoC_meas_SIMO_DSS_sweep_islr_change_CT.png")  
  makeBoxPlot(delays,vals3,"ISLR Change Height (dB)","RFSoC_meas_SIMO_DSS_sweep_islr_change_hgt.png")
  
  # display(boxplot(delays,vals1',title = "ISLR Change Cross-Track (dB)",
  #  xlabel = "Delay Since Last Sync (s)", legend = false))
  # savefig("RFSoC_meas_SIMO_DSS_sweep_islr_change_CT.png")
  # display(boxplot(delays,vals2',title = "ISLR Change Along-Track (dB)",
  #  xlabel = "Delay Since Last Sync (s)", legend = false))
  # savefig("RFSoC_meas_SIMO_DSS_sweep_islr_change_AT.png")
  # display(boxplot(delays,vals3',title = "ISLR Change Height (dB)",
  #  xlabel = "Delay Since Last Sync (s)", legend = false))
  # savefig("RFSoC_meas_SIMO_DSS_sweep_islr_change_hgt.png")
  ...
  makeBoxPlot(delays,vals1,"Resolution Change Along-Track (m)","RFSoC_meas_SIMO_DSS_sweep_resolution_change_AT.png")
  makeBoxPlot(delays,vals2,"Resolution Change Cross-Track (m)","RFSoC_meas_SIMO_DSS_sweep_resolution_change_CT.png")
  makeBoxPlot(delays,vals3,"Resolution Change Height (m)","RFSoC_meas_SIMO_DSS_sweep_resolution_change_hgt.png")
  
  
  # display(boxplot(delays,vals1',title = "Resolution Change Cross-Track",
  #  xlabel = "Delay Since Last Sync (s)", legend = false))
  # savefig("RFSoC_meas_SIMO_DSS_sweep_resolution_change_CT.png")
  # display(boxplot(delays,vals2',title = "Resolution Change Along-Track (m)",
  #  xlabel = "Delay Since Last Sync (s)", legend = false))
  # savefig("RFSoC_meas_SIMO_DSS_sweep_resolution_change_AT.png")
  # display(boxplot(delays,vals3',title = "Resolution Change Height (m)",
  #  xlabel = "Delay Since Last Sync (s)", legend = false))
  # savefig("RFSoC_meas_SIMO_DSS_sweep_resolution_change_hgt.png")

  # ---- Peak location error ------
  vals1 = filterNaNs2D(loc_errors[1,:,:])
  vals2 = filterNaNs2D(loc_errors[2,:,:])
  vals3 = filterNaNs2D(loc_errors[3,:,:])
  makeBoxPlot(delays,vals1,"Peak Location Error Along-Track (m)","RFSoC_meas_SIMO_DSS_sweep_peak_loc_AT.png")
  makeBoxPlot(delays,vals2,"Peak Location Error Cross-Track (m)","RFSoC_meas_SIMO_DSS_sweep_peak_loc_CT.png")
  makeBoxPlot(delays,vals3,"Peak Location Error Height (m)","RFSoC_meas_SIMO_DSS_sweep_peak_loc_hgt.png")
  
  # display(boxplot(DSS_plot, vals1', title = "Peak Location Error Cross-Track (m)",
  #  xlabel = "Delay Since Last Sync (s)", legend = false))
  #  savefig("RFSoC_meas_SIMO_DSS_sweep_peak_loc_lat.png")
  # display(boxplot(DSS_plot, vals2', title = "Peak Location Error Along-Track (m)",
  #   xlabel = "Delay Since Last Sync (s)", legend = false))
  #   savefig("RFSoC_meas_SIMO_DSS_sweep_peak_loc_lon.png")
  # display(boxplot(DSS_plot, vals3', title = "Peak Location Error Height (m)",
  #    xlabel = "Delay Since Last Sync (s)", legend = false))
  # savefig("RFSoC_meas_SIMO_DSS_sweep_peak_loc_hgt.png")
