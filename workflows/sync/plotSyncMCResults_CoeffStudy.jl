...
begin
  filename = "sync data/Lband/syncModule_MonteCarlo_mode_2_coeff_number5_sync_osc_sweep_wSync.jld2"
  @load filename peaks resolutions PSLRs ISLRs ideal_res ideal_PSLR ideal_ISLR ideal_peak loc_errors osc_coeff_sweep
  gr()

  #matrices are either (numcoeff5 x numTrials) or (3 x numcoeff5 x numTrials)
...
## trying box plots
  ...
  display(boxplot(coeff_plot, peakvals', title = "Peak Power Loss Oscillator Coefficient #5", ylabel = "Power Loss (dB)",
    xlabel = "PSD Coefficient Value (dB)", legend = false))
  # savefig("SIMO_coeff5_sweep_no_phase_ramp_peak_loss.png")
  savefig("SIMO_coeff5_sweep_peak_loss.png")
  ...
  makeBoxPlot(osc_coeff_sweep,vals1,"PSLR Change Along-Track (dB)","SIMO_coeff5_sweep_no_phase_ramp_pslr_change_AT.png")
  makeBoxPlot(osc_coeff_sweep,vals2,"PSLR Change Cross-Track (dB)","SIMO_coeff5_sweep_no_phase_ramp_pslr_change_CT.png")
  makeBoxPlot(osc_coeff_sweep,vals3,"PSLR Change Height (dB)","SIMO_coeff5_sweep_no_phase_ramp_pslr_change_hgt.png")
  ...
  # savefig("SIMO_coeff5_sweep_no_phase_ramp_pslr_change_CT.png")
  # display(boxplot(osc_coeff_sweep,vals2',title = "PSLR Change Along-Track (dB)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("SIMO_coeff5_sweep_no_phase_ramp_pslr_change_AT.png")
  # display(boxplot(osc_coeff_sweep,vals3',title = "PSLR Change Height (dB)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("SIMO_coeff5_sweep_no_phase_ramp_pslr_change_hgt.png")
  ...
  makeBoxPlot(osc_coeff_sweep,vals1,"ISLR Change Along-Track (dB)","SIMO_coeff5_sweep_no_phase_ramp_islr_change_AT.png")
  makeBoxPlot(osc_coeff_sweep,vals2,"ISLR Change Cross-Track (dB)","SIMO_coeff5_sweep_no_phase_ramp_islr_change_CT.png")
  makeBoxPlot(osc_coeff_sweep,vals3,"ISLR Change Height (dB)","SIMO_coeff5_sweep_no_phase_ramp_islr_change_hgt.png")

  # display(boxplot(osc_coeff_sweep,vals1',title = "ISLR Change Cross-Track (dB)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("SIMO_coeff5_sweep_no_phase_ramp_islr_change_CT.png")
  # display(boxplot(osc_coeff_sweep,vals2',title = "ISLR Change Along-Track (dB)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("SIMO_coeff5_sweep_no_phase_ramp_islr_change_AT.png")
  # display(boxplot(osc_coeff_sweep,vals3',title = "ISLR Change Height (dB)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("SIMO_coeff5_sweep_no_phase_ramp_islr_change_hgt.png")
  ...
  makeBoxPlot(osc_coeff_sweep,vals1,"Resolution Change Along-Track (m)","SIMO_coeff5_sweep_no_phase_ramp_resolution_change_AT.png")
  makeBoxPlot(osc_coeff_sweep,vals2,"Resolution Change Cross-Track (m)","SIMO_coeff5_sweep_no_phase_ramp_resolution_change_CT.png")
  makeBoxPlot(osc_coeff_sweep,vals3,"Resolution Change Height (m)","SIMO_coeff5_sweep_no_phase_ramp_resolution_change_hgt.png")


  # display(boxplot(osc_coeff_sweep,vals1',title = "Resolution Change Cross-Track",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("SIMO_coeff5_sweep_no_phase_ramp_resolution_change_CT.png")
  # display(boxplot(osc_coeff_sweep,vals2',title = "Resolution Change Along-Track (m)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("SIMO_coeff5_sweep_no_phase_ramp_resolution_change_AT.png")
  # display(boxplot(osc_coeff_sweep,vals3',title = "Resolution Change Height (m)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("SIMO_coeff5_sweep_no_phase_ramp_resolution_change_hgt.png")

  # ---- Peak location error ------
  vals1 = filterNaNs2D(loc_errors[1,:,:])
  vals2 = filterNaNs2D(loc_errors[2,:,:])
  vals3 = filterNaNs2D(loc_errors[3,:,:])
  makeBoxPlot(osc_coeff_sweep,vals1,"Peak Location Error Along-Track (m)","SIMO_coeff5_sweep_no_phase_ramp_peak_loc_AT.png")
  makeBoxPlot(osc_coeff_sweep,vals2,"Peak Location Error Cross-Track (m)","SIMO_coeff5_sweep_no_phase_ramp_peak_loc_CT.png")
  makeBoxPlot(osc_coeff_sweep,vals3,"Peak Location Error Height (m)","SIMO_coeff5_sweep_no_phase_ramp_peak_loc_hgt.png")

  # display(boxplot(coeff_plot, vals1', title = "Peak Location Error Cross-Track (m)",
  #  xlabel = "Sync Repetition Interval (s)", legend = false))
  #  savefig("SIMO_coeff5_sweep_no_phase_ramp_peak_loc_lat.png")
  # display(boxplot(coeff_plot, vals2', title = "Peak Location Error Along-Track (m)",
  #   xlabel = "Sync Repetition Interval (s)", legend = false))
  #   savefig("SIMO_coeff5_sweep_no_phase_ramp_peak_loc_lon.png")
  # display(boxplot(coeff_plot, vals3', title = "Peak Location Error Height (m)",
  #    xlabel = "Sync Repetition Interval (s)", legend = false))
  # savefig("SIMO_coeff5_sweep_no_phase_ramp_peak_loc_hgt.png")
