...
s_geom_filepath         = "/Users/joshil/Documents/Outputs/InSAR Outputs/Geo_outputs_set1/2/2_scene_geometry_1.tif" 
t_geom_filepath         = "/Users/joshil/Documents/Outputs/InSAR Outputs/Geo_outputs_set1/2/2_target_geometry_1.tif" 
opdata_filepath         = "/Users/joshil/Documents/Outputs/InSAR Outputs/Geo_outputs_set1/2/2_sim_output_main_1.tif" 

# Mention the directory to save plots
savepath                 = "/Users/joshil/Documents/Outputs/InSAR Outputs/Geo_outputs_set1/2/Plots_s/"
...
plot_geometry_variables(s_geom_data, Lon_vals, Lat_vals, maxind_val_lon, maxind_val_lat, geom_savepath)

geom_savepath = savepath*"Geom_plots_t/"
plot_geometry_variables(t_geom_data, Lon_vals, Lat_vals, maxind_val_lon, maxind_val_lat, geom_savepath)


data_op                 = ArchGDAL.read(opdata_filepath)
...
gamma_ip = mean(s_geom_data[1,:,12])

A = plot_interferogram_histogram_statistics_phase(Int_Phase_multilooked[:], gamma_ip, Looks_along_Lat*Looks_along_Lon,0.0, (-0.5,0.5), savepath*"Int_plots/", "PDF_Phase_Han1")
A = plot_interferogram_histogram_statistics_phase_han1(Int_Phase_multilooked[:], gamma_ip, Looks_along_Lat*Looks_along_Lon, 0.0, (-0.5,0.5), savepath*"Int_plots/", "PDF_Phase_Han2")
B = plot_interferogram_histogram_statistics_magnitude(Int_Pow_multilooked[:], gamma_ip, Looks_along_Lat*Looks_along_Lon, (0.5,1), savepath*"Int_plots/", "PDF_Mag_Han1")
