...
function main_RSF_slowtime_surfaceBRCS(t_xyz_grid,p_xyz_3D,Srx,t_rx,ref_range,t_ref, params) # with RSF, slow-time, and surface BRCS calculation
    ...
    #   #TODO 1) Convert SCH targets (AKA the surface locations s_loc_1 and s_loc_2 grid) into ECEF. 
    #   #TODO 2) Get average positions of the transmitter(s)

    #   t_ref_3d[i]  = Scattering.get_surface_brcs(params,tx_ecef,rx_ecef,tgt_ecef,patch_area) 
    # end#for
